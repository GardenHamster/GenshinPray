...
INSERT INTO `genshinpray`.`goods`(`Id`, `GoodsName`, `GoodsType`, `GoodsSubType`, `RareType`, `IsPerm`, `CreateDate`, `IsDisable`) VALUES (78, '和璞鸢', 2, 10, 5, 1, '2021-08-25 23:36:38', 1);
...
INSERT INTO `genshinpray`.`goods`(`Id`, `GoodsName`, `GoodsType`, `GoodsSubType`, `RareType`, `IsPerm`, `CreateDate`, `IsDisable`) VALUES (80, '天空之翼', 2, 12, 5, 1, '2021-08-25 23:36:38', 1);
...
-- ----------------------------
INSERT INTO `genshinpray`.`pond_goods`(`Id`, `AuthId`, `PondType`, `GoodsId`) VALUES (1, 0, 1, 53);
INSERT INTO `genshinpray`.`pond_goods`(`Id`, `AuthId`, `PondType`, `GoodsId`) VALUES (2, 0, 1, 38);
INSERT INTO `genshinpray`.`pond_goods`(`Id`, `AuthId`, `PondType`, `GoodsId`) VALUES (3, 0, 1, 47);
INSERT INTO `genshinpray`.`pond_goods`(`Id`, `AuthId`, `PondType`, `GoodsId`) VALUES (4, 0, 1, 37);
INSERT INTO `genshinpray`.`pond_goods`(`Id`, `AuthId`, `PondType`, `GoodsId`) VALUES (5, 0, 2, 70);
INSERT INTO `genshinpray`.`pond_goods`(`Id`, `AuthId`, `PondType`, `GoodsId`) VALUES (6, 0, 2, 72);
INSERT INTO `genshinpray`.`pond_goods`(`Id`, `AuthId`, `PondType`, `GoodsId`) VALUES (7, 0, 2, 29);
INSERT INTO `genshinpray`.`pond_goods`(`Id`, `AuthId`, `PondType`, `GoodsId`) VALUES (8, 0, 2, 24);
INSERT INTO `genshinpray`.`pond_goods`(`Id`, `AuthId`, `PondType`, `GoodsId`) VALUES (9, 0, 2, 23);
INSERT INTO `genshinpray`.`pond_goods`(`Id`, `AuthId`, `PondType`, `GoodsId`) VALUES (10, 0, 2, 19);
INSERT INTO `genshinpray`.`pond_goods`(`Id`, `AuthId`, `PondType`, `GoodsId`) VALUES (11, 0, 2, 17);
